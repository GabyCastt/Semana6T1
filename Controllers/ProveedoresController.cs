...
namespace Roles_Estructuras_Control.Controllers
{
    ...
    public class ProveedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreProveedor,Dirección,Teleforno,Correo")] ProveedoresModels proveedoresModels)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreProveedor,Dirección,Teleforno,Correo")] ProveedoresModels proveedoresModels)
        {
