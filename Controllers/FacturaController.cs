...
namespace Roles_Estructuras_Control.Controllers
{
    public class FacturaController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Factura.Include(f => f.ClientesModel);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var facturaModel = await _context.Factura
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var facturaModel = await _context.Factura.FindAsync(id);
            if (facturaModel == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (facturaModel != null)
            {
                _context.Factura.Remove(facturaModel);
            }
