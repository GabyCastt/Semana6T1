...
namespace Roles_Estructuras_Control.Controllers
{
    public class DetalleFacturaController : Controller
    {
        ...
        {
            var applicationDbContext = _context.DetalleFactura.Include(d => d.FacturaModel).Include(d => d.ProductoModels).Include(d => d.StockModels);
        ...
        {
            ViewData["FacturaModelId"] = new SelectList(_context.Factura, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,Cantidad,Valor,ProductoModelsId,FacturaModelId,StockModelsId")] DetalleFacturaModel detalleFacturaModel)
        {
            ...
            ViewData["FacturaModelId"] = new SelectList(_context.Factura, "Id", "Id", detalleFacturaModel.FacturaModelId);
